...
$(function () {
	...
	for (var i = 1; i <= $(".crankcount").length; i++) {
		_loop(i);
	}
});
//优选好物
$(function () {
	...
	for (var i = 1; i <= $(".tabcontent1").length; i++) {
		_loop2(i);
	}
});
...
$(function () {
	$(".input1")[0].oninput = function () {
		...
		console.log("safas");
		var val = $(".input1").val();
		$.getJSON("http://suggest.taobao.com/sug?q=" + val + "&callback=?", function (data) {
			var str = "";
