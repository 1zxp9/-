				...
				var _loop = function _loop(i) {
					if (id == data[i].gid) {
						...
						$("#leftbtn").click(function () {
							...
							num1--;
							$("#ainput").val(num1);
							$.get("http://47.104.244.134:8080/cartupdate.do", { "id": data[i].id, "gid": data[i].gid, "num": "-1", "token": token }, function (data) {
								console.log(data);
							});
						});
						$("#rightbtn").click(function () {
						...
						var textamount = $("#ainput").val();
						$("#ainput").change(function () {
							var textamount1 = $("#ainput").val();
							$.get("http://47.104.244.134:8080/cartupdate.do", { "id": data[i].id, "gid": data[i].gid, "num": textamount1 - textamount, "token": token }, function (data) {
								console.log("dsada");
							});
						});
					}
